classdef HYSYSFile_case_studies  < matlab.mixin.Copyable
    ...
    methods
        function obj = HYSYSFile_case_studies(filepath, spreadsheet_input, spreadsheet_output) % Constructor method
